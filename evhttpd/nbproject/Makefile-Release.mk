...
${OBJECTDIR}/HttpUtils.o: HttpUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpUtils.o HttpUtils.cpp

${OBJECTDIR}/http_1.1/Http11Handler.o: http_1.1/Http11Handler.cpp 
	${MKDIR} -p ${OBJECTDIR}/http_1.1
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/http_1.1/Http11Handler.o http_1.1/Http11Handler.cpp
...
${OBJECTDIR}/HttpHandlerManager.o: HttpHandlerManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpHandlerManager.o HttpHandlerManager.cpp

${OBJECTDIR}/RWIOPump.o: RWIOPump.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RWIOPump.o RWIOPump.cpp

${OBJECTDIR}/ChunkedBodyBuilder.o: ChunkedBodyBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ChunkedBodyBuilder.o ChunkedBodyBuilder.cpp
...
${OBJECTDIR}/HttpHandler.o: HttpHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpHandler.o HttpHandler.cpp

${OBJECTDIR}/EvNIOWriter.o: EvNIOWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EvNIOWriter.o EvNIOWriter.cpp

${OBJECTDIR}/CleanerTimer.o: CleanerTimer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CleanerTimer.o CleanerTimer.cpp

${OBJECTDIR}/event/EventDispatcher.o: event/EventDispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/event
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/event/EventDispatcher.o event/EventDispatcher.cpp

${OBJECTDIR}/SocketUtils.o: SocketUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SocketUtils.o SocketUtils.cpp

${OBJECTDIR}/Dispatcher.o: Dispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Dispatcher.o Dispatcher.cpp

${OBJECTDIR}/http_1.0/Http10HandlerFactory.o: http_1.0/Http10HandlerFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/http_1.0
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/http_1.0/Http10HandlerFactory.o http_1.0/Http10HandlerFactory.cpp

${OBJECTDIR}/SocketNIOWriter.o: SocketNIOWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SocketNIOWriter.o SocketNIOWriter.cpp

${OBJECTDIR}/http_1.0/Http10Handler.o: http_1.0/Http10Handler.cpp 
	${MKDIR} -p ${OBJECTDIR}/http_1.0
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/http_1.0/Http10Handler.o http_1.0/Http10Handler.cpp
...
${OBJECTDIR}/SendfileIOPump.o: SendfileIOPump.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SendfileIOPump.o SendfileIOPump.cpp

${OBJECTDIR}/RequestData.o: RequestData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RequestData.o RequestData.cpp
...
${OBJECTDIR}/EvNIOReader.o: EvNIOReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EvNIOReader.o EvNIOReader.cpp

${OBJECTDIR}/SocketNIOReader.o: SocketNIOReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SocketNIOReader.o SocketNIOReader.cpp

${OBJECTDIR}/AbstractIOPump.o: AbstractIOPump.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AbstractIOPump.o AbstractIOPump.cpp

${OBJECTDIR}/HttpProcess.o: HttpProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpProcess.o HttpProcess.cpp

${OBJECTDIR}/HttpHandlerFactory.o: HttpHandlerFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpHandlerFactory.o HttpHandlerFactory.cpp
...
${OBJECTDIR}/ProcessSignal.o: ProcessSignal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ProcessSignal.o ProcessSignal.cpp

${OBJECTDIR}/HttpServletManager.o: HttpServletManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HttpServletManager.o HttpServletManager.cpp

${OBJECTDIR}/http_1.1/Http11HandlerFactory.o: http_1.1/Http11HandlerFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/http_1.1
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/http_1.1/Http11HandlerFactory.o http_1.1/Http11HandlerFactory.cpp

${OBJECTDIR}/test/test.o: test/test.cpp 
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/test/test.o test/test.cpp
...
${OBJECTDIR}/ProcessFDSender.o: ProcessFDSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ProcessFDSender.o ProcessFDSender.cpp
